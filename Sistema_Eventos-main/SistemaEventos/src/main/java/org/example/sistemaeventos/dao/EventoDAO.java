...
public class EventoDAO implements CRUD<Evento> {
    ...
    public void guardar(Evento nuevoEvento) {
        String sql = "INSERT INTO eventos (nombre, tipo, inicio, fin, fecha, estado) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection con = ConexionBD.getInstancia().conectar();
            ...
            String estado = (nuevoEvento.getEstado() != null && !nuevoEvento.getEstado().isEmpty())
                    ? nuevoEvento.getEstado() : "pendiente";
    ...
    public void actualizar(Evento evento) {
        String sql = "UPDATE eventos SET nombre = ?, tipo = ?, inicio = ?, fin = ?, fecha = ?, estado = ? WHERE id = ?";
